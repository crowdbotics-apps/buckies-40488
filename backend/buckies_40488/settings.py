"""
Django settings for buckies_40488 project.
...
ROOT_URLCONF = 'buckies_40488.urls'
...
WSGI_APPLICATION = 'buckies_40488.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "buckies_40488 API",
    "DESCRIPTION": "API documentation for buckies_40488 App",
    "VERSION": "v1",
}
